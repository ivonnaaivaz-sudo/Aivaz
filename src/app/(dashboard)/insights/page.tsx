...
import { Sparkles, Loader2, ShieldAlert, CheckCircle2, RefreshCw, MessageSquare, ExternalLink, Info } from "lucide-react";
    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-20">
      ...
      {isDemoMode && (
        <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/10 flex items-center gap-3 text-amber-500/80 text-sm">
          ...
          <span>Showing sample Intelligence. Complete the Psychological Discovery to synthesize real family-level recommendations.</span>
        </div>
      )}
