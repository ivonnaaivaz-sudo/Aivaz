  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b pb-8">
        ...
        <div className="flex items-center gap-4 bg-white shadow-xl p-5 rounded-2xl border border-primary/10">
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-[8px] font-bold uppercase">3 High Priority Actions</Badge>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link href="/chart-room" className="group">
                <Card className="border-none shadow-lg hover:ring-2 hover:ring-primary/30 transition-all h-full bg-primary/5">
              ...
              <Link href="/vault" className="group">
                <Card className="border-none shadow-lg hover:ring-2 hover:ring-blue-600/30 transition-all h-full bg-blue-50/50">
                  <CardContent className="p-6 space-y-4">
                    <div className="p-2 w-10 h-10 rounded-lg bg-blue-600/10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="border-none shadow-xl bg-white">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="p-4 rounded-xl bg-muted/50 border border-transparent group hover:border-primary/30 transition-all cursor-pointer">
              ...
              <div className="p-4 rounded-xl bg-muted/50 border border-transparent group hover:border-primary/30 transition-all cursor-pointer">
                <p className="text-[10px] font-bold text-amber-600 uppercase tracking-widest">Capital Efficiency</p>
              ...
              <div className="p-4 rounded-xl bg-muted/50 border border-transparent group hover:border-primary/30 transition-all cursor-pointer">
                <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">Heritage Opportunity</p>
          ...
          <Card className="border-none shadow-xl bg-primary/5">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-end border-b pb-2">
                ...
                <Badge variant="outline" className="text-[8px] bg-white">Aggregated</Badge>
              </div>
              <div className="flex justify-between items-end">
                <div>
                  <p className="text-[9px] text-amber-600 uppercase font-bold tracking-widest">Idle Capital Risk</p>
                  <p className="text-xl font-headline font-bold text-amber-600">€42.0M</p>
                </div>
                <Badge className="bg-amber-100 text-amber-600 border-amber-200 text-[8px] font-bold uppercase">Action Required</Badge>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="block group">
        <Link href="/academy">
          <Card className="border border-primary/20 bg-primary/5 p-8 flex items-center justify-between transition-all hover:bg-primary/10 shadow-lg">
